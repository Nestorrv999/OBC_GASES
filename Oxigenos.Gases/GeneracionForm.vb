...
#Region "Eventos Panel GeneracionDocumentos"
    ...
    Private Sub btnRegresar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRegresar.Click
        MessageBox.Show("Sr usuario tenga en cuenta que tendra que escanear y/o digitar la información cargada nuevamente") 'DATASCAN 20170220
...
DeNuevo:
    ...
    Public Sub InsertEncabezadoGuia(ByVal sTipoMovimiento As String, ByVal RowTalonario As DataRow)
        ...
        If Row Is Nothing Then
            ...
            'mtovar inserción en guiadocumento
            Try
