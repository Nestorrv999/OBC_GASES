...
'
'Microsoft.CompactFramework.Design.Data generó automáticamente este código fuente, versión=2.0.50727.8806.
'
        ...
        Public Property CapacidadNumerico() As Integer
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("El valor de la columna 'CapacidadNumerico' de la tabla 'KardexCamion' es DBNull.", e)
                End Try
            End Get
            Set
    ...
    Partial Public Class ProductosRow
        ...
        Public Property CodFlete() As String
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("El valor de la columna 'CodFlete' de la tabla 'Productos' es DBNull.", e)
                End Try
            End Get
            Set
        ...
        Public Property GeneraMovSerial() As String
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("El valor de la columna 'GeneraMovSerial' de la tabla 'Productos' es DBNull.", e)
                End Try
            End Get
            Set
        ...
        Public Property LeeBarras() As String
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("El valor de la columna 'LeeBarras' de la tabla 'Productos' es DBNull.", e)
                End Try
            End Get
            Set
    ...
    Partial Public Class CilindrosClienteRow
        ...
        Public Property Seleccionado() As String
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("El valor de la columna 'Seleccionado' de la tabla 'CilindrosCliente' es DBNull.", e)
                End Try
            End Get
            Set
        ...
        Public Property Sucursal() As String
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("El valor de la columna 'Sucursal' de la tabla 'CilindrosCliente' es DBNull.", e)
                End Try
            End Get
            Set
        ...
        Public Property Capacidad() As String
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("El valor de la columna 'Capacidad' de la tabla 'CilindrosCliente' es DBNull.", e)
                End Try
            End Get
            Set
...
Namespace ProductosDataSetTableAdapters
    ...
    Partial Public Class KardexCamionTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT     CodProducto, Capacidad, CantidadPraxair, SaldoPraxair, CantidadCliente"& _ 
                ", SaldoCliente, CodSucursal, CodTipoProducto"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         KardexCamion"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE  "& _ 
                "   (CodProducto = @CodProducto) AND (Capacidad = @Capacidad) AND (CodTipoProduct"& _ 
                "o = @CodTipoProducto)"
            ...
            Me._commandCollection(1).CommandText = "DELETE FROM KardexCamion"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (CodProducto = @CodProducto) AND (Capacidad ="& _ 
            ...
            Me._commandCollection(3).CommandText = "INSERT INTO KardexCamion"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                      (CodProducto, Capacidad, Cantidad"& _ 
                "Praxair, SaldoPraxair, CantidadCliente, SaldoCliente, CodSucursal, CodTipoProduc"& _ 
                "to)"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"VALUES     (@CodProducto, @Capacidad, @CantidadPraxair, @SaldoPraxair, @Can"& _ 
                "tidadCliente, @SaldoCliente, @CodSucursal, @CodTipoProducto)"
            ...
            Me._commandCollection(4).CommandText = "UPDATE    KardexCamion"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SET              CantidadPraxair = @CantidadPraxair, Sald"& _ 
                "oPraxair = @SaldoPraxair, CantidadCliente = @CantidadCliente, SaldoCliente = @Sa"& _ 
                "ldoCliente"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (CodProducto = @CodProducto) AND (Capacidad = @Capacidad) "& _ 
                "AND (CodTipoProducto = @CodTipoProducto)"
    ...
    Partial Public Class ProductosTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            param.ParameterName = "@p11"
            param.IsNullable = true
            param.SourceColumn = "GeneraMovSerial"
            Me._adapter.InsertCommand.Parameters.Add(param)
            param = New Global.System.Data.SqlServerCe.SqlCeParameter
            param.ParameterName = "@p12"
            param.IsNullable = true
            param.SourceColumn = "LeeBarras"
            Me._adapter.InsertCommand.Parameters.Add(param)
            Me._adapter.UpdateCommand = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._adapter.UpdateCommand.Connection = Me.Connection
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT     Codigo, Descripcion, UnidadMedida, Lastro, CodTipoProducto, RequiereAs"& _ 
                "ignacion, RequiereFlete, Precio, Iva, CodFlete, GeneraMovSerial, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"             "& _ 
                "         LeeBarras"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         Productos"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (Codigo = @Codigo)"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.System.Data.SqlServerCe.SqlCeParameter = New Global.System.Data.SqlServerCe.SqlCeParameter
            ...
            Me._commandCollection(1) = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        Codigo, Descripcion, UnidadMedida, Lastro, CodTipoProducto, Requier"& _ 
                "eAsignacion, RequiereFlete, Precio, Iva, CodFlete, GeneraMovSerial, LeeBarras"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"F"& _ 
                "ROM            Productos"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (Codigo = @Codigo)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            param = New Global.System.Data.SqlServerCe.SqlCeParameter
            param.ParameterName = "@Codigo"
            param.Size = 8
            ...
            Me._commandCollection(2) = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._commandCollection(2).Connection = Me.Connection
            Me._commandCollection(2).CommandText = "SELECT     Codigo, Descripcion, UnidadMedida, Lastro, CodTipoProducto, RequiereAs"& _ 
                "ignacion, RequiereFlete, Precio, Iva, CodFlete, GeneraMovSerial, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"             "& _ 
                "         LeeBarras"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         Productos"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (CodTipoProducto = @CodTip"& _ 
                "oProducto)"
            Me._commandCollection(2).CommandType = Global.System.Data.CommandType.Text
            param = New Global.System.Data.SqlServerCe.SqlCeParameter
            param.ParameterName = "@CodTipoProducto"
            ...
            Me._commandCollection(3) = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._commandCollection(3).Connection = Me.Connection
            Me._commandCollection(3).CommandText = "SELECT     Codigo, Descripcion, UnidadMedida, Lastro, CodTipoProducto, RequiereAs"& _ 
                "ignacion, RequiereFlete, Precio, Iva, CodFlete, GeneraMovSerial, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"             "& _ 
                "         LeeBarras"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         Productos"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     RequiereAsignacion = '1'"
            Me._commandCollection(3).CommandType = Global.System.Data.CommandType.Text
        End Sub
    ...
    Partial Public Class PertenenciaTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT     Codigo, Descripcion"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         Pertenencia"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
    ...
    Partial Public Class ActivoProductoTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT     CodProducto, Capacidad, CodActivo, CapacidadActivo"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         Activ"& _ 
                "oProducto"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (CodProducto = @CodProducto) AND (Capacidad = @Capacidad)"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.System.Data.SqlServerCe.SqlCeParameter = New Global.System.Data.SqlServerCe.SqlCeParameter
            param.ParameterName = "@CodProducto"
            param.Size = 8
    ...
    Partial Public Class CargaTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT [CodSucursal], [CodProducto], [Capacidad], [Secuencial], [Pertenencia], [N"& _ 
                "oCarga], [EstadoEntrega], [CodTipoProducto], [SecuencialAjeno] FROM [Carga]"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"whe"& _ 
                "re Secuencial = @Secuencial"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.System.Data.SqlServerCe.SqlCeParameter = New Global.System.Data.SqlServerCe.SqlCeParameter
    ...
    Partial Public Class CilindrosClienteTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT     CodCliente, CodProducto, Serie, Seleccionado, Sucursal, Secuencial, Ca"& _ 
                "pacidad"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         CilindrosCliente"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (Secuencial = @Secuencial)"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.System.Data.SqlServerCe.SqlCeParameter = New Global.System.Data.SqlServerCe.SqlCeParameter
            param.ParameterName = "@Secuencial"
            param.Size = 8
            ...
            Me._commandCollection(1).CommandText = "SELECT     CodCliente, CodProducto, Serie, Seleccionado, Sucursal, Secuencial, Ca"& _ 
                "pacidad"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         CilindrosCliente"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (Serie= @Serie)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            param = New Global.System.Data.SqlServerCe.SqlCeParameter
