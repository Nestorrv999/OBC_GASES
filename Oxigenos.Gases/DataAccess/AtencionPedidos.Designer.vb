    ...
    Partial Public Class DetallePedidoRow
        ...
        Public Property NoAutorizacion() As String
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("El valor de la columna 'NoAutorizacion' de la tabla 'DetallePedido' es DBNull.", e)
                End Try
            End Get
            Set
    ...
    Partial Public Class DetalleGuiaAsignacionesRecoleccionesRow
        ...
        Public Property Cantidad() As Short
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("El valor de la columna 'Cantidad' de la tabla 'DetalleGuiaAsignacionesRecoleccion"& _ 
                            "es' es DBNull.", e)
                End Try
            End Get
            Set
        ...
        Public Property UnidadVenta() As String
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("El valor de la columna 'UnidadVenta' de la tabla 'DetalleGuiaAsignacionesRecolecc"& _ 
                            "iones' es DBNull.", e)
                End Try
            End Get
            Set
...
Namespace AtencionPedidosTableAdapters
    ...
    Partial Public Class DetallePedidoTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT [NoPedido], [CodProducto], [Capacidad], [UnidadesVendidasPraxair], [Unidad"& _ 
                ...
                "tado], [SubTotalCredito], [MontoTotalContado], [MontoTotalCredito], [MontoTotalC"& _ 
                "opago], [MontoTotalCuota], [PrecioContado], [PrecioCredito], [PorcentajeImpuesto"& _ 
                "], [PorcentajeDescuento] FROM [DetallePedido]"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"where [NoPedido]=@pNoPedido"
    ...
    Partial Public Class DetalleGuiaAsignacionesRecoleccionesTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1) = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "select sum(convert(numeric,capacidad))"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"from DetalleGuiaAsignacionesRecolecciones"& _ 
                ""&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"where codproducto=@producto"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"and nomovimiento in(select NoMovimiento from Maes"& _ 
                "troGuias where NoPedido=@pedido)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.System.Data.SqlServerCe.SqlCeParameter = New Global.System.Data.SqlServerCe.SqlCeParameter
    ...
    Partial Public Class DetalleGuiaFacturasRemisionesTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1) = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT     SUM(CONVERT(numeric, Capacidad)) AS EXPR1"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         DetalleGuiaFac"& _ 
                "turasRemisiones"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (CodProducto = @producto) AND (NoMovimiento IN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"     "& _ 
                "                     (SELECT     NoMovimiento"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                            FROM "& _ 
                "         MaestroGuias"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                            WHERE      (NoPedido = @pedid"& _ 
                "o)))"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.System.Data.SqlServerCe.SqlCeParameter = New Global.System.Data.SqlServerCe.SqlCeParameter
            param.ParameterName = "@producto"
