...
Namespace VentaDataSetTableAdapters
    ...
    Partial Public Class DetalleGuiaRecoleccionesAjenosTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT [NoMovimiento], [NoGuia], [TipoMovimiento], [CodProducto], [Capacidad], [S"& _ 
                "ecuencial], [CodSucursal], [CodCliente], [Prefijo] FROM [DetalleGuiaRecoleccione"& _ 
                "sAjenos]"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"    (CodCliente = @CodCliente) AND (Secuencial = @Secuencial)"
    ...
    Partial Public Class MaestroFacturasTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT     TipoFactura, NoFactura, Prefijo, CodSucursal, CodCliente, Fecha, Moned"& _ 
                ...
                "                   CodTipoPago, NoDiasCredito, EstadoFactura, OrdenCompra, Monto"& _ 
                "Factura, MontoFlete, Descuento, ImpuestoTotal, CodEntidad, NoPedido"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM       "& _ 
                "  MaestroFacturas"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (NoFactura = @NoFactura)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.System.Data.SqlServerCe.SqlCeParameter = New Global.System.Data.SqlServerCe.SqlCeParameter
    ...
    Partial Public Class CilindrosLeidosTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT     CodSucursal, CodProducto, Capacidad, Secuencial, Pertenencia, CodTipoP"& _ 
                "roducto, SecuencialAjeno, Cantidad, UnidadMedida, Credito, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                   "& _ 
                "   CantidadAsignada"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         CilindrosLeidos"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
    ...
    Partial Public Class PreciosTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT     CodSucursal, CodCliente, CodProducto, PrecioNeto, PorcentajeDescuento,"& _ 
                " PorcentajeImpuesto, CodTipoMoneda, AplicaIva, TieneContrato, Estado, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"        "& _ 
                "              Acarreo"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         Precios"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (CodSucursal = @CodSucurs"& _ 
                "al) AND (CodCliente = @CodCliente) AND (CodProducto = @CodProducto)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.System.Data.SqlServerCe.SqlCeParameter = New Global.System.Data.SqlServerCe.SqlCeParameter
    ...
    Partial Public Class MaestroGuiasTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            param.ParameterName = "@p2"
            param.IsNullable = true
            param.SourceColumn = "CodSucursalOrigen"
            Me._adapter.InsertCommand.Parameters.Add(param)
            param = New Global.System.Data.SqlServerCe.SqlCeParameter
            param.ParameterName = "@p3"
            param.IsNullable = true
            param.SourceColumn = "CodSucursalDestino"
            Me._adapter.InsertCommand.Parameters.Add(param)
            param = New Global.System.Data.SqlServerCe.SqlCeParameter
            param.ParameterName = "@p4"
            param.IsNullable = true
            ...
            param.ParameterName = "@p12"
            param.IsNullable = true
            param.SourceColumn = "CodCisterna"
            Me._adapter.InsertCommand.Parameters.Add(param)
            param = New Global.System.Data.SqlServerCe.SqlCeParameter
            param.ParameterName = "@p13"
            param.IsNullable = true
            ...
            param.DbType = Global.System.Data.DbType.[Decimal]
            param.IsNullable = true
            param.SourceColumn = "Reimpresion"
            Me._adapter.InsertCommand.Parameters.Add(param)
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        NoMovimiento, CodSucursalOrigen, CodSucursalDestino, CodCliente, Fe"& _ 
                ...
                "o, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         CodCisterna, NoViaje, NoPedido, PrefijoFactura, Re"& _ 
                "impresion"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            MaestroGuias"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT     MAX(CONVERT(int, NoMovimiento)) AS NoMovimiento"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         MaestroG"& _ 
                "uias"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(2) = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._commandCollection(2).Connection = Me.Connection
            Me._commandCollection(2).CommandText = "UPDATE    MaestroGuias"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SET              Reimpresion = @Reimpresion"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (N"& _ 
                "oFactura = @Nofactura) AND (CodCliente = @CodCliente) AND (TipoDocumento = @Tipo"& _ 
                "Documento)"
            Me._commandCollection(2).CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.System.Data.SqlServerCe.SqlCeParameter = New Global.System.Data.SqlServerCe.SqlCeParameter
            param.ParameterName = "@Reimpresion"
            param.DbType = Global.System.Data.DbType.Decimal
            param.Size = 19
            param.IsNullable = true
            param.SourceColumn = "Reimpresion"
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Overridable Function NumMovimientoActual() As String
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Overridable Function UpdateQuery(ByVal Reimpresion As Object, ByVal Nofactura As String, ByVal CodCliente As String, ByVal TipoDocumento As String) As Object
            Dim command As Global.System.Data.SqlServerCe.SqlCeCommand = Me.CommandCollection(2)
            If (Reimpresion Is Nothing) Then
                command.Parameters(0).Value = Global.System.DBNull.Value
            Else
                command.Parameters(0).Value = CType(Reimpresion,Object)
            End If
            If (Nofactura Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Nofactura")
            Else
    ...
    Partial Public Class CopiasDocumentosTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT        CodTipoDocumento, Orden, Descripcion"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            CopiasDocumen"& _ 
                "tos"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        CodTipoDocumento, Orden, Descripcion"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            CopiasDocumen"& _ 
                "tos"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"Where  CodTipoDocumento = @CodDocumento"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"order by orden"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.System.Data.SqlServerCe.SqlCeParameter = New Global.System.Data.SqlServerCe.SqlCeParameter
    ...
    Partial Public Class DocumentosTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT        CodTipoDocumento, Descripcion, Sigla"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Documentos"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        CodTipoDocumento, Descripcion, Sigla"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Documentos"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"W"& _ 
                "here  CodTipoDocumento = @CodTipoDocumento"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.System.Data.SqlServerCe.SqlCeParameter = New Global.System.Data.SqlServerCe.SqlCeParameter
